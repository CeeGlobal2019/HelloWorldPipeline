# HelloWorldPipeline
Simple demonstration to set up a “Hello World” Jenkins pipeline in Blue Ocean.

This repository provides the supporting material to Build CI/CD Pipelines. 
...
#### 2. Jenkins on Ubuntu VM or Amazon Linux VM
